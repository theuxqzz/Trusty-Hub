...
local Window = OrionLib:MakeWindow({Name = "Trusty Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Trusty Hub"})

OrionLib:MakeNotification({
	Name = "Trusty Hub",
	Content = "Choose Teams Bro?",
	Image = "rbxassetid://79668114798487",
	Time = 7
})
...
local W = Window:MakeTab({
    Name = "Welcome",
    Icon = "rbxassetid://79668114798487",
    PremiumOnly = false
})
